...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		// makeRecipe(new ComparableStack(ModItems.centrifuge_tower, 1), new AStack[] { new ComparableStack(ModItems.centrifuge_element, 4), new OreDictStack(STEEL.plate(), 4), new ComparableStack(ModItems.wire_red_copper, 6), new OreDictStack(LAPIS.dust(), 2), new OreDictStack(POLYMER.ingot(), 2), }, 150);
		...
		//makeRecipe(new ComparableStack(ModItems.cyclotron_tower, 1), new AStack[] { new ComparableStack(ModItems.magnet_circular, 6), new ComparableStack(ModItems.magnet_dee, 3), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModItems.wire_advanced_alloy, 8), new OreDictStack(POLYMER.plate(), 24), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.thermo_unit_empty, 1), new AStack[] { new ComparableStack(ModItems.coil_copper_torus, 3), new OreDictStack(STEEL.ingot(), 3), new OreDictStack(TI.plate(), 6), new OreDictStack(POLYMER.plate(), 12), new OreDictStack(BR.ingot(), 2), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.warhead_generic_medium, 1), new AStack[] { new OreDictStack(TI.plate(), 8), new OreDictStack(STEEL.plate(), 5), new OreDictStack(ANY_PLASTICEXPLOSIVE.ingot(), 4), }, 150);
		makeRecipe(new ComparableStack(ModItems.warhead_generic_large, 1), new AStack[] { new OreDictStack(TI.plate(), 15), new OreDictStack(STEEL.plate(), 8), new OreDictStack(ANY_PLASTICEXPLOSIVE.ingot(), 8), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.sat_base, 1), new AStack[] { new ComparableStack(ModItems.thruster_large, 1), new OreDictStack(STEEL.plate(), 6), new OreDictStack(DESH.plate(), 4), new ComparableStack(ModItems.hull_big_titanium, 3), new NbtComparableStack(ItemFluidTank.getFullBarrel(ModForgeFluids.kerosene)), new ComparableStack(ModItems.photo_panel, 24), new ComparableStack(ModItems.board_copper, 12), new ComparableStack(ModItems.circuit_gold, 6), new ComparableStack(ModItems.battery_lithium_cell_6, 1), }, 500);
		makeRecipe(new ComparableStack(ModItems.sat_head_mapper, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 4), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.hull_small_steel, 3), new OreDictStack(DESH.plate(), 2), new ComparableStack(ModItems.circuit_gold, 2), new OreDictStack(POLYMER.plate(), 12), new ComparableStack(Items.REDSTONE, 6), new ComparableStack(Items.DIAMOND, 1), new ComparableStack(Blocks.GLASS_PANE, 6), }, 400);
		makeRecipe(new ComparableStack(ModItems.sat_head_scanner, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 6), new OreDictStack(TI.plate(), 32), new OreDictStack(DESH.plate(), 6), new ComparableStack(ModItems.magnetron, 6), new ComparableStack(ModItems.coil_advanced_torus, 2), new ComparableStack(ModItems.circuit_gold, 6), new OreDictStack(POLYMER.plate(), 6), new ComparableStack(Items.DIAMOND, 1), }, 400);
		makeRecipe(new ComparableStack(ModItems.sat_head_radar, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 4), new OreDictStack(TI.plate(), 32), new ComparableStack(ModItems.magnetron, 12), new OreDictStack(POLYMER.plate(), 16), new ComparableStack(ModItems.wire_red_copper, 16), new ComparableStack(ModItems.coil_gold, 3), new ComparableStack(ModItems.circuit_gold, 5), new ComparableStack(Items.DIAMOND, 1), }, 400);
		makeRecipe(new ComparableStack(ModItems.sat_head_laser, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 12), new OreDictStack(W.ingot(), 16), new OreDictStack(POLYMER.ingot(), 6), new OreDictStack(POLYMER.plate(), 16), new ComparableStack(ModItems.board_copper, 24), new ComparableStack(ModItems.circuit_targeting_tier5, 2), new ComparableStack(Items.REDSTONE, 16), new ComparableStack(Items.DIAMOND, 5), new ComparableStack(Blocks.GLASS_PANE, 16), }, 450);
		makeRecipe(new ComparableStack(ModItems.sat_head_resonator, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 32), new OreDictStack(POLYMER.ingot(), 48), new OreDictStack(POLYMER.plate(), 8), new ComparableStack(ModItems.crystal_xen, 1), new OreDictStack(STAR.ingot(), 7), new ComparableStack(ModItems.circuit_targeting_tier5, 6), new ComparableStack(ModItems.circuit_targeting_tier6, 2), }, 1000);
		makeRecipe(new ComparableStack(ModItems.sat_foeq, 1), new AStack[] { new OreDictStack(STEEL.plate(), 8), new OreDictStack(TI.plate(), 12), new OreDictStack(DESH.plate(), 8), new ComparableStack(ModItems.hull_big_titanium, 3), new NbtComparableStack(ItemFluidTank.getFullBarrel(FluidRegistry.WATER)), new ComparableStack(ModItems.photo_panel, 16), new ComparableStack(ModItems.thruster_nuclear, 1), new ComparableStack(ModItems.rod_quad_uranium_fuel, 2), new ComparableStack(ModItems.circuit_targeting_tier5, 6), new ComparableStack(ModItems.magnetron, 3), new ComparableStack(ModItems.battery_lithium_cell_6, 1), }, 1200);
		makeRecipe(new ComparableStack(ModItems.sat_miner, 1), new AStack[] { new OreDictStack(BIGMT.plate(), 24), new OreDictStack(DESH.plate(), 8), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.drill_titanium, 2), new ComparableStack(ModItems.circuit_targeting_tier4, 2), new NbtComparableStack(ItemFluidTank.getFullBarrel(ModForgeFluids.kerosene)), new ComparableStack(ModItems.thruster_small, 1), new ComparableStack(ModItems.photo_panel, 12), new ComparableStack(ModItems.centrifuge_element, 4), new ComparableStack(ModItems.magnetron, 3), new OreDictStack(POLYMER.plate(), 12), new ComparableStack(ModItems.battery_lithium_cell_6, 1), }, 600);
		...
		makeRecipe(new ComparableStack(ModItems.circuit_red_copper, 1), new AStack[] {new ComparableStack(ModItems.circuit_copper, 1), new ComparableStack(ModItems.wire_red_copper, 4), new OreDictStack(GOLD.dust(), 1), new OreDictStack(POLYMER.plate(), 1), },150);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_effect_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(DURA.dust(), 4), new OreDictStack(DURA.dust(), 6), new ComparableStack(ModItems.wire_red_copper, 4), }, 200);
		makeRecipe(new ComparableStack(ModItems.upgrade_effect_2, 1), new AStack[] { new ComparableStack(ModItems.upgrade_effect_1, 1), new OreDictStack(DURA.dust(), 2), new OreDictStack(DURA.dust(), 4), new ComparableStack(ModItems.circuit_red_copper, 4), new ComparableStack(ModItems.wire_red_copper, 4), new OreDictStack(POLYMER.ingot(), 2), }, 300);
		makeRecipe(new ComparableStack(ModItems.upgrade_effect_3, 1), new AStack[] { new ComparableStack(ModItems.upgrade_effect_2, 1), new OreDictStack(DURA.dust(), 2), new OreDictStack(DURA.dust(), 6), new OreDictStack(DESH.ingot(), 4), }, 500);
		...
		makeRecipe(new ComparableStack(ModItems.part_lithium, 1), new AStack[] { new OreDictStack(POLYMER.plate(), 1), new OreDictStack(LI.dust(), 1), }, 50);
		makeRecipe(new ComparableStack(ModItems.part_beryllium, 1), new AStack[] { new OreDictStack(POLYMER.plate(), 1), new OreDictStack(BE.dust(), 1), }, 50);
		makeRecipe(new ComparableStack(ModItems.part_carbon, 1), new AStack[] { new OreDictStack(POLYMER.plate(), 1), new OreDictStack(COAL.dust(), 1), }, 50);
		makeRecipe(new ComparableStack(ModItems.part_copper, 1), new AStack[] { new OreDictStack(POLYMER.plate(), 1), new OreDictStack(CU.dust(), 1), }, 50);
		makeRecipe(new ComparableStack(ModItems.part_plutonium, 1), new AStack[] { new OreDictStack(POLYMER.plate(), 1), new OreDictStack(PU.dust(), 1), }, 50);
		...
		makeRecipe(new ComparableStack(ModItems.bottle_empty, 6), new AStack[] { 
			new ComparableStack(KEY_ANYPANE, 6), }, 20);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_schrabidium_transmutator, 1), new AStack[] { new OreDictStack(MAGTUNG.ingot(), 1), new OreDictStack(TI.ingot(), 24), new OreDictStack(ALLOY.plate(), 18), new OreDictStack(STEEL.plate(), 12), new OreDictStack(DESH.plate(), 6), new OreDictStack(POLYMER.plate(), 8), new ComparableStack(ModBlocks.machine_battery, 5), new ComparableStack(ModItems.circuit_gold, 5), }, 500);
		...
		makeRecipe(new ComparableStack(ModItems.boy_igniter, 1), new AStack[] { new OreDictStack(AL.plate(), 6), new OreDictStack(STEEL.plate(), 1), new ComparableStack(ModItems.circuit_red_copper, 1), new ComparableStack(ModItems.wire_red_copper, 3), }, 100);
		makeRecipe(new ComparableStack(ModItems.man_explosive, 1), new AStack[] { new ComparableStack(Blocks.TNT, 2), new OreDictStack(ANY_PLASTICEXPLOSIVE.ingot(), 3), new OreDictStack(STEEL.plate(), 2), new OreDictStack(TI.plate(), 4), new ComparableStack(ModItems.wire_red_copper, 3), }, 150);
		...
		makeRecipe(new ComparableStack(ModItems.fleija_propellant, 1), new AStack[] { new ComparableStack(Blocks.TNT, 3), new OreDictStack(SA326.plate(), 8), new ComparableStack(ModItems.ingot_tennessine, 2), }, 400);
		...
		makeRecipe(new ComparableStack(ModItems.solinium_propellant, 1), new AStack[] { new ComparableStack(Blocks.TNT, 3), new OreDictStack(OreDictManager.getReflector(), 2), new OreDictStack(POLYMER.plate(), 6), new ComparableStack(ModItems.wire_tungsten, 6), new ComparableStack(ModItems.biomass_compressed, 4), }, 350);
		...
		makeRecipe(new ComparableStack(ModItems.gun_egon, 1), new AStack[] {new ComparableStack(ModItems.mechanism_special, 4), new OreDictStack(STEEL.plate(), 16), new OreDictStack(PB.plate(), 24), new ComparableStack(ModItems.coil_advanced_torus, 32), new ComparableStack(ModItems.circuit_targeting_tier6, 4), new OreDictStack(POLYMER.plate(), 8), new ComparableStack(ModBlocks.machine_lithium_battery, 2), new ComparableStack(ModBlocks.machine_waste_drum, 1), new ComparableStack(ModItems.wire_copper, 8)}, 256);
		makeRecipe(new ComparableStack(ModBlocks.silo_hatch, 1), new AStack[]{new ComparableStack(ModItems.motor, 8), new OreDictStack(STEEL.ingot(), 32), new ComparableStack(ModItems.hull_big_steel, 8), new OreDictStack(POLYMER.plate(), 4), new ComparableStack(ModItems.pipes_steel, 2), new OreDictStack(REDSTONE.dust(), 4), }, 300);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_chungus, 1), new AStack[] {
			...
			makeRecipe(new ComparableStack(ModBlocks.bm_power_box, 1), new AStack[] {
				new ComparableStack(ModItems.hull_big_steel, 6),
		...
		makeRecipe(new ComparableStack(ModBlocks.rbmk_blank, 1), new AStack[] {
				...
				new OreDictStack(POLYMER.plate(), 4)
			}, 100);
		...
		if(!GeneralConfig.enable528) {
			...
			makeRecipe(new ComparableStack(ModBlocks.machine_cyclotron, 1), new AStack[] {
					...
					new OreDictStack(AL.plate(), 32),
					new OreDictStack(POLYMER.ingot(), 24),
					new OreDictStack(POLYMER.plate(), 64),
					new ComparableStack(ModItems.board_copper, 8),
					new ComparableStack(ModItems.circuit_red_copper, 8),
			...
			makeRecipe(new ComparableStack(ModBlocks.rbmk_console, 1), new AStack[] {
					new OreDictStack(STEEL.ingot(), 16),
					new OreDictStack(AL.plate(), 32),
					new OreDictStack(POLYMER.plate(), 16),
		...
		makeRecipe(new ComparableStack(ModBlocks.railgun_plasma, 1), new AStack[]{new OreDictStack(STEEL.plate(), 24), new ComparableStack(ModItems.hull_big_steel, 2), new ComparableStack(ModItems.hull_small_steel, 6), new ComparableStack(ModItems.pipes_steel, 2), new ComparableStack(ModBlocks.machine_lithium_battery, 4), new ComparableStack(ModItems.coil_copper, 16), new ComparableStack(ModItems.coil_copper_torus, 8), new OreDictStack(DESH.plate(), 4), new ComparableStack(ModItems.circuit_targeting_tier4, 4), new ComparableStack(ModItems.circuit_targeting_tier3, 2), new OreDictStack(POLYMER.ingot(), 4)}, 500);
